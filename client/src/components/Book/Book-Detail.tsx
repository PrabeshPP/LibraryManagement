          ...
          <div className={classes["desc-container"]}>
            ...
            <div className=' h-[60%] w-[90%] flex flex-col pl-5'>
              ...
              <p className=' mt-5'>{book.summary}</p>
              {
                ...
                </div> : book.isAvailable ? <button onClick={onAddToCart} className='mt-5 text-[white] flex justify-center items-center text-mdfont-semibold bg-[#3a10e5] rounded-sm cursor-pointer h-[6vh] hover:shadow-lg hover:shadow-black w-[40%] hover:bg-[#3b10e5ce] hover:text-white'>Borrow Book</button> :
