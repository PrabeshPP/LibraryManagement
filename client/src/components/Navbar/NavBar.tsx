...
const NavBar = () => {
    ...
    const authenticatedCookie = Cookies.get("_uj1");
    ...
    return (
        <div className={isScrolled ? 'font-sans h-[10vh] w-[100%] flex flex-row justify-between sticky top-0 z-50 bg-white transition-all' : 'font-sans h-[10vh] w-[100%] flex flex-row justify-between sticky top-0 z-50 transition-all'}>
            ...
            <div className='h-[100%] w-[60%] flex flex-row justify-around items-center'>
                <NavLink to={"/home/books"} className='text-[#10162f] '>
                    {/* <IoBookSharp/> */}
                    <p className=' ml-1 hover:text-[#3a10e5] font-bold cursor-pointer'>Books</p>
                </NavLink>
                <NavLink to={"/home/borrowed-books"} className='text-[#10162f]'>
                    {/* <BsCartFill/> */}
                ...
                </NavLink>
                {
                    ...
                    </div> : <NavLink to={"/user/signin"} className='text-[white] flex justify-center items-center text-lg font-semibold bg-[#3a10e5] rounded-sm cursor-pointer h-[65%] w-[15%] hover:bg-[#3b10e5ce] hover:text-white'>
                        {/* <BiLogIn/> */}
